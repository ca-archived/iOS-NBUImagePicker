...
#define NBUIMAGEPICKER_MODULE_UI            1
#define NBUIMAGEPICKER_MODULE_CAMERA_ASSETS 2
#define NBUIMAGEPICKER_MODULE_IMAGE         3
#define NBUIMAGEPICKER_MODULE_HELPERS       4
#define NBUIMAGEPICKER_MODULE_COMPATIBILITY 9
